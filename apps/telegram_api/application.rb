...
module TelegramApi
  class Application < Lotus::Application
    configure do
      ...
      #
      layout :application # It will load TelegramApi::Views::ApplicationLayout
      ...
      # Configure the code that will yield each time TelegramApi::Action is included
      ...
      # Configure the code that will yield each time TelegramApi::View is included
      # This is useful for sharing common functionality
      #
